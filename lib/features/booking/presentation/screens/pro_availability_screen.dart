            ...
            if (state.loading && state.rules.isEmpty)
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: SpotbookCard(
                    child: const Text(
                      'Aucune plage horaire. Ajoute au moins une règle (ex. Lun 9h–17h, créneaux de 60 min).',
            ...
            if (state.slotsForSelectedDate.isEmpty && !state.loading)
              SliverToBoxAdapter(
                child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 20),
                  child: Text(
                    'Pas de créneau ce jour-là. Lance « Générer les créneaux » ou choisis une autre date.',
                    style: TextStyle(
