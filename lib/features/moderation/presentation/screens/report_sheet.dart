...
class _ReportSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // viewInsets.bottom = hauteur du clavier ; viewPadding.bottom = home indicator.
    // Additionner les deux évite que le bouton "Envoyer" passe sous le clavier
    // ou sous la barre de gestes iOS.
