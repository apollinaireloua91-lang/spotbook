...
class DeleteAccountScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: AppColors.fond, title: const Text('Delete account')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('This action cannot be undone', style: TextStyle(color: AppColors.blanc, fontSize: 22, fontWeight: FontWeight.bold)),
