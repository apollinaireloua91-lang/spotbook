              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Votre compte sera désactivé pendant 30 jours avant la suppression définitive. Vos données seront effacées et ne pourront pas être récupérées.', style: TextStyle(color: AppColors.gris, fontSize: 15, height: 1.5)),
                    ...
                    SizedBox(width: double.infinity, height: 52, child: ElevatedButton(
                      onPressed: s.confirmed && !s.isLoading ? () async {
                        try {
                          ...
                          if (context.mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('La suppression a échoué. Veuillez réessayer.'), backgroundColor: AppColors.error));
                        }
                      } : null,
